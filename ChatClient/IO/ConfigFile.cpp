...
const string ConfigFile::NAME_{"my_client_name"};
const string ConfigFile::MAX_WIDTH_{"max_width"};

const unordered_map<string, string> ConfigFile::defaultConfigFile = {
        pair<string, string>(PASSWD_,"000"),
        pair<string, string>(IP_,"127.0.0.1"),
		pair<string, string>(PORT_,"56789"),
        pair<string, string>(NAME_,"anonymity"),
        pair<string, string>(MAX_WIDTH_,"80")
};
